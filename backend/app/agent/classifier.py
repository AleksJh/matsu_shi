...
Если в промпте присутствует блок "Контекст сессии" — это follow-up вопрос
в активной диагностической сессии. Классифицируй как "complex", так как
ответ требует понимания всего диагностического контекста.
